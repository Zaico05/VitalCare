            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-white px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <a href="about.html" class="nav-item nav-link">Carrito</a>
                        <a href="service.html" class="nav-item nav-link">Historial</a>
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Emergencias</a>
                            <div class="dropdown-menu m-0">
                                <a href="appointment.html" class="dropdown-item">Hospitales</a>
                                <a href="feature.html" class="dropdown-item">Farmacias</a>
                    ...
                    <a href="#" class="btn btn-primary rounded-pill text-white py-2 px-4 flex-wrap flex-sm-shrink-0">Registrate</a>
                </div>
            </nav>
        <!-- Navbar End -->
      ...
      <div class="col-md-6 col-lg-6 col-xl-4 wow fadeInUp" data-wow-delay="0.1s">
        <div class="blog-item rounded">
          ...
          <div class="blog-centent p-4">
            ...
            <a href="#" class="btn btn-primary rounded-pill text-white py-2 px-4 mb-1">Ver más</a>
          </div>
        </div>
      </div>
